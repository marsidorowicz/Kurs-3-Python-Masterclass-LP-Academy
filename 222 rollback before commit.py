...
class Account(object):
    ...
    def _save_update(self, amount):
        ...
        try:
            ...
            db.rollback()  # trzeba zrobić rollback inaczej przy następnym komicie zostaną wczytane
        else:
            self._balance = new_balance  #tu lepiej niż w try bo nie trzeba tego chronić
        finally:
            db.commit()
